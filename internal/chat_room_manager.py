...
class ChatRoomManeger:
    def __init__(self, account_1: UserAccount, account_2: UserAccount) -> None:
        self.__id: UUID = uuid4()
        self.__account_1: UserAccount = account_1
        self.__account_2: UserAccount = account_2
    ...
    def id(self) -> UUID:
        return self.__id
    @property
    def account_1(self) -> UserAccount:
        return self.__account_1
    @property
    def account_2(self) -> UserAccount:
        return self.__account_2
    @property
    def message_list(self) -> list:
        return self.__message_list
    
    async def connect(self, websocket: WebSocket, account: UserAccount):
    ...
    def disconnect(self, websocket: WebSocket, account: UserAccount):
    ...
    async def add_message(self, message: str, account: UserAccount) -> Message:
